...
class MainView extends React.Component {
  ...
  getMovies(token) {
    axios
      .get("https://ancas-myflixapi.herokuapp.com/movies", {
  ...
  getGenres(token) {
    axios
      .get("https://ancas-myflixapi.herokuapp.com/genres", {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
  ...
  getUser(token, UserID) {
    axios
      .get(`https://ancas-myflixapi.herokuapp.com/users/${UserID}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
                ...
                <div className="genre-view">
                  ...
                  <Row className="genre-view-container m-0">
                    <Col xs={12} sm={10} md={8} lg={6} xl={4}>
                      <GenreView
                        genre={genres.find(
                          (genre) => genre.Name === match.params.name
                        )}
                        onBackClick={() => history.goBack()}
                      />
                    </Col>
