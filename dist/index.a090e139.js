...
null == i &&
  ...
  i("27Lyk").register(
    JSON.parse(
      '{"gjX5N":"index.a090e139.js","1jTiu":"logo.a06c53b0.png","7iWYh":"index.b53e99f0.css"}'
    )
  );
var s = {};
s = i("1b2ls");
...
function Pg(e) {
  const t = (0, l.useRef)();
  (0, l.useEffect)(() => {
    "account" === n.Username && t.current.focus();
  }, []);
  const n = e.user,
    o = n._id,
    a = e.onLoggedOut,
        ...
        children: (0, s.jsxs)(nr.Body, {
          children: [
            ...
            (0, s.jsx)(Qf, {
              ...
              onSubmit: (t) => {
                r(st)
                  .put(`https://myflix-bna0.onrender.com/users/${o}`, t, {
                    headers: { Authorization: `Bearer ${i}` },
                  })
                  .then((t) => {
                    const r = t.data;
                    alert(`${n.Username} has been updated`),
                      e.updateUser(r),
                      location.reload();
                  })
                  .catch((e) => {
                  ...
                  (0, s.jsxs)(Xs, {
                    ...
                    children: [
                      (0, s.jsx)(td, {
                        ...
                        required: !0,
                        disabled: (function () {
                          if ("account" === n.Username) return !0;
                        })(),
                      }),
                      (0, s.jsx)("label", {
                        htmlFor: "Username",
                        ...
                        (0, s.jsx)("a", {
                          ...
                          onClick: (e) => {
                            ...
                            window.confirm(
                              ...
                              ? r(st)
                                  .delete(
                                    `https://myflix-bna0.onrender.com/users/${o}`,
                                    {
                                      headers: { Authorization: `Bearer ${i}` },
                                    }
                                  )
                                  .then((e) => {
                                    alert(`${n.Username} has been deactivated`),
                                      a();
                                  })
                                  .catch(function (e) {
...
//# sourceMappingURL=index.a090e139.js.map
